...
@interface PaintingNoteViewController () <UITableViewDelegate, UITableViewDataSource, UITextViewDelegate>

@property (nonatomic) PaintingNoteView *noteView;
...
@implementation PaintingNoteViewController
...
- (void)viewDidLoad {
    ...
    self.noteView = [[PaintingNoteView alloc] init];
    ...
    __block __weak PaintingNoteViewController *weakself = self;
