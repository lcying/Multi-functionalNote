...
@interface PicNoteViewController ()<UITableViewDelegate, UITableViewDataSource, UITextViewDelegate>

@property (nonatomic) ReadPicNoteView *readView;
...
- (void)viewDidLoad {
    ...
    self.readView = [[ReadPicNoteView alloc] init];
    ...
    __block __weak PicNoteViewController *weakself = self;
